/**
 * INMOBILIARIA ZAMORA - Main Application
    ...
    return `
      <article class="property-card reveal" data-id="${property.id}" style="animation-delay: ${index * 50}ms">
        ...
        <div class="property-card__content">
          <p class="property-card__price">${property.showPrice !== false ? formatPrice(property.price, property.currency) : 'Precio: Consultar'}</p>
          ...
          <p class="property-card__location">
            ...
            ${property.location.neighborhood ? property.location.neighborhood + ', ' : ''}${property.location.city}
          </p>
