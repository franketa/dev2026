...
/** Pasa un número a letras. Un boleto sin el importe en letras no sirve. */
  ...
  return (
    <div className="min-h-screen bg-[#0a0e14] print:bg-white py-8 print:py-0">
      <div className="no-imprimir max-w-[800px] mx-auto mb-4 flex justify-between items-center px-6">
        <a href={`/ventas/${id}`} className="text-[13px] text-[#9aa7b8] hover:text-white">← Volver a la venta</a>
        <BotonImprimir />
      </div>
